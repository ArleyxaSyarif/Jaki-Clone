      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={tw`px-4 mt-4`}>
          ...
          <TouchableOpacity style={tw`bg-blue-50 p-3 rounded-xl mb-3 flex-row items-center`}>
            ...
            />
            <View style={tw`flex-1`}>
              <Text style={tw`font-semibold text-gray-700`}>MRTJ</Text>
        ...
        <Link href="/projek/jaklingko1">
          <View style={tw`flex-row justify-center items-center mt-4 w-[50%] rounded-lg p-3 self-center`}>
            <Text style={tw`text-blue-500 text-lg font-semibold bg-transparent border-2 border-blue-500 p-2 rounded-lg py-3 px-12`}>Next Page</Text>
          </View>      
        </Link>
